...
require('lazy').setup({
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          if client and client:supports_method(vim.lsp.protocol.Methods.textDocument_documentHighlight) then
            ...
            -- vim.lsp.buf.clear_references keeps throwing a warning in vscode
            else
    ...
    init = function()
      ...
      local function is_dark_mode()
        if vim.fn.has 'mac' == 1 then
          ...
          local result = handle:read '*a'
          handle:close()
          if result:match 'prefer%-dark' then return true end
          if result:match 'prefer%-light' then return false end
  ...
  { -- Specifically for highlighting color codes
